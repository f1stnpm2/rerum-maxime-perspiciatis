# @f1stnpm2/rerum-maxime-perspiciatis

[![Build Status](https://secure.travis-ci.org/nathanboktae/@f1stnpm2/rerum-maxime-perspiciatis.png)](http://travis-ci.org/nathanboktae/@f1stnpm2/rerum-maxime-perspiciatis)

@f1stnpm2/rerum-maxime-perspiciatis is an extension to the [chai](http://chaijs.com/) assertion library that
...
```
npm install @f1stnpm2/rerum-maxime-perspiciatis
```

### bower

```
bower install @f1stnpm2/rerum-maxime-perspiciatis
```
...
chai.use(require('@f1stnpm2/rerum-maxime-perspiciatis'))
```

### AMD

```javascript
require(['chai', '@f1stnpm2/rerum-maxime-perspiciatis'], function(chai, chaiDom) {
  chai.use(chaiDom)
})
```
...
<script src="@f1stnpm2/rerum-maxime-perspiciatis.js"></script>
```
